...
st.title("🎅 Interaktywny Mikołaj z Streamlit")
st.markdown("---")

# Ustawienia rysunku
# fig musi być zdefiniowane, aby móc przekazać je do st.pyplot
...
# --------------------
# WIDŻET STREAMLIT DLA PREZENTÓW
# --------------------
# Użycie st.checkbox do kontrolowania widoczności
show_gifts = st.checkbox("🎁 Wyświetl prezenty", value=True) 

if show_gifts:
    st.subheader("Sekcja Prezentów")
    # TŁO / PREZENTY
    ...
    st.info("Prezenty ukryte. Kliknij checkbox, aby je zobaczyć!")

# Zakres osi, żeby wszystko było widać (pozostaje stały)
ax.set_xlim(-2.5, 2.8) 
ax.set_ylim(-2.0, 3.0)
